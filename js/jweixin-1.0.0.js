! function() {
    ...
    wx.onMenuShareTimeline = function onMenuShareTimeline(params) {
        ...
        weiXin.registerApp(
            function(ret, err) {
                ...
                api.download({
                    savePath: "fs://weChatIcon" + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + ".png",
                    cache: false,
                    url: url
                }, function(ret, err) {
                    if (!ret) {
    ...
    wx.onMenuShareQQ = function onMenuShareQQ(params) {
        ...
        qq.login(
            function(ret, err) {
                ...
                var url = params.imgUrl;
                api.download({
                    savePath: "fs://qqIcon" + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + ".png",
                    cache: false,
                    url: url
                }, function(ret, err) {
                    if (!ret) {
    ...
    wx.downloadImage = function downloadImage(params) {
        ...
        api.download({
            savePath: "fs://weChatLocalId" + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + ".png",
            cache: false,
            url: url
        }, function(ret, err) {
            if (params.isShowProgressTips) {
    ...
    wx.startRecord = function startRecord(params) {
        ...
        api.startRecord({
            path: "fs://weChatVoice" + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + ".amr"
        });
    }
    ...
    wx.downloadVoice = function downloadVoice(params) {
        ...
        var url = params.serverId;
        api.download({
            savePath: "fs://weChatLocalId" + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + Math.floor(Math.random() * 1000000) + ".amr",
            cache: false,
            url: url
        }, function(ret, err) {
            if (params.isShowProgressTips) {
    ...
    (function() {
        ...
        function e(n) {
            var e, t, r = "",
                o = -1,
                f;
            if (n && n.length) { f = n.length;
                while ((o += 1) < f) { e = n.charCodeAt(o);
                    t = o + 1 < f ? n.charCodeAt(o + 1) : 0;
                    if (55296 <= e && e <= 56319 && 56320 <= t && t <= 57343) { e = 65536 + ((e & 1023) << 10) + (t & 1023);
                        o += 1 }
                    if (e <= 127) { r += String.fromCharCode(e) } else if (e <= 2047) { r += String.fromCharCode(192 | e >>> 6 & 31, 128 | e & 63) } else if (e <= 65535) { r += String.fromCharCode(224 | e >>> 12 & 15, 128 | e >>> 6 & 63, 128 | e & 63) } else if (e <= 2097151) { r += String.fromCharCode(240 | e >>> 18 & 7, 128 | e >>> 12 & 63, 128 | e >>> 6 & 63, 128 | e & 63) } } }
            return r }
        ...
        function t(n) {
            var e, t, r, o, f, i = [],
                h;
            e = t = r = o = f = 0;
            if (n && n.length) { h = n.length;
                n += "";
                while (e < h) { r = n.charCodeAt(e);
                    t += 1;
                    if (r < 128) { i[t] = String.fromCharCode(r);
                        e += 1 } else if (r > 191 && r < 224) { o = n.charCodeAt(e + 1);
                        i[t] = String.fromCharCode((r & 31) << 6 | o & 63);
                        e += 2 } else { o = n.charCodeAt(e + 1);
                        f = n.charCodeAt(e + 2);
        ...
        function i(n) {
            var e, t = n.length,
                r = "";
            for (e = 0; e < t; e += 1) { r += String.fromCharCode(n.charCodeAt(e) & 255, n.charCodeAt(e) >>> 8 & 255) }
            return r }

        function h(n) {
            var e, t = n.length,
                r = "";
            for (e = 0; e < t; e += 1) { r += String.fromCharCode(n.charCodeAt(e) >>> 8 & 255, n.charCodeAt(e) & 255) }
            return r }

        function u(n) {
            var e, t = n.length * 32,
                r = "";
            for (e = 0; e < t; e += 8) { r += String.fromCharCode(n[e >> 5] >>> 24 - e % 32 & 255) }
            return r }
        ...
        function c(n) {
            ...
            for (e = 0; e < t; e += 8) { r[e >> 5] |= (n.charCodeAt(e / 8) & 255) << e % 32 }
            return r }
        ...
        function l(n) {
            var e, t = n.length * 8,
                ...
                o = r.length;
            for (e = 0; e < o; e += 1) { r[e] = 0 }
            for (e = 0; e < t; e += 8) { r[e >> 5] |= (n.charCodeAt(e / 8) & 255) << 24 - e % 32 }
            return r }
        ...
        function D(n, e) {
            ...
            h = a.length;
            for (o = 0; o < h; o += 1) { a[o] = n.charCodeAt(o * 2) << 8 | n.charCodeAt(o * 2 + 1) }
            while (a.length > 0) { u = Array();
                i = 0;
                for (o = 0; o < a.length; o += 1) { i = (i << 16) + a[o];
                    f = Math.floor(i / t);
                    i -= f * t;
        ...
        function B(n, e) {
            var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
                ...
                f, i, h;
            e = e || "=";
            for (f = 0; f < o; f += 3) { h = n.charCodeAt(f) << 16 | (f + 1 < o ? n.charCodeAt(f + 1) << 8 : 0) | (f + 2 < o ? n.charCodeAt(f + 2) : 0);
                for (i = 0; i < 4; i += 1) {
                    if (f * 8 + i * 6 > n.length * 8) { r += e } else { r += t.charAt(h >>> 6 * (3 - i) & 63) } } }
            return r }
        n = { VERSION: "1.0.5", Base64: function() {
                ...
                this.encode = function(t) {
                    ...
                    r = r || "=";
                    t = f ? e(t) : t;
                    for (o = 0; o < a; o += 3) { h = t.charCodeAt(o) << 16 | (o + 1 < a ? t.charCodeAt(o + 1) << 8 : 0) | (o + 2 < a ? t.charCodeAt(o + 2) : 0);
                        for (i = 0; i < 4; i += 1) {
                            if (o * 8 + i * 6 > a * 8) { u += r } else { u += n.charAt(h >>> 6 * (3 - i) & 63) } } }
                    return u };
                this.decode = function(e) {
                    ...
                    do { a = n.indexOf(e.charAt(o += 1));
                        ...
                        u = B & 255;
                        C += 1;
                        if (l === 64) { s[C] = String.fromCharCode(i) } else if (D === 64) { s[C] = String.fromCharCode(i, h) } else { s[C] = String.fromCharCode(i, h, u) } } while (o < e.length);
                    A = s.join("");
                    A = f ? t(A) : A;
                    return A };
                this.setPad = function(n) { r = n || r;
                    return this };
                this.setTab = function(e) { n = e || n;
                    return this };
                this.setUTF8 = function(n) {
                    if (typeof n === "boolean") { f = n }
                    return this } }, CRC32: function(n) {
                var t = 0,
                    r = 0,
                    o = 0,
                    f, i, h;
                ...
                t = t ^ -1;
                for (i = 0, h = n.length; i < h; i += 1) { o = (t ^ n.charCodeAt(i)) & 255;
                    r = "0x" + f.substr(o * 9, 8);
                    t = t >>> 8 ^ r }
                return (t ^ -1) >>> 0 }, MD5: function(n) {
                ...
                this.setUpperCase = function(n) {
                    ...
                    return this };
                this.setPad = function(n) { i = n || i;
                    return this };
                this.setUTF8 = function(n) {
                    if (typeof n === "boolean") { h = n }
                    return this };

                function u(n) { n = h ? e(n) : n;
                ...
                function l(n, t) {
                    ...
                    for (u = 0; u < 16; u += 1) { o[u] = r[u] ^ 909522486;
                        f[u] = r[u] ^ 1549556828 }
                ...
                function E(n, e, t, r, o, f, i) {
                    return A(t ^ (e | ~r), n, e, o, f, i) } }, SHA1: function(n) {
                var t = n && typeof n.uppercase === "boolean" ? n.uppercase : false,
                    i = n && typeof n.pad === "string" ? n.pda : "=",
                    h = n && typeof n.utf8 === "boolean" ? n.utf8 : true;
                this.hex = function(n) {
                ...
                function c(n, t) {
                    ...
                    if (r.length > 16) { r = C(r, n.length * 8) }
                    o = Array(16), f = Array(16);
                    for (i = 0; i < 16; i += 1) { o[i] = r[i] ^ 909522486;
                        f[i] = r[i] ^ 1549556828 }
                ...
                function C(n, e) {
                    ...
                    n[e >> 5] |= 128 << 24 - e % 32;
                    n[(e + 64 >> 9 << 4) + 15] = e;
                    for (t = 0; t < n.length; t += 16) { h = B, u = C;
                        a = w;
                        c = F;
                        l = E;
                        for (f = 0; f < 80; f += 1) {
                            if (f < 16) { D[f] = n[t + f] } else { D[f] = o(D[f - 3] ^ D[f - 8] ^ D[f - 14] ^ D[f - 16], 1) }
                ...
                function s(n) {
                    return n < 20 ? 1518500249 : n < 40 ? 1859775393 : n < 60 ? -1894007588 : -899497514 } }, SHA256: function(n) {
                var t = n && typeof n.uppercase === "boolean" ? n.uppercase : false,
                ...
                this.setUpperCase = function(n) {
                    if (typeof n === "boolean") { t = n }
                    return this };
                this.setPad = function(n) { o = n || o;
                    return this };
                this.setUTF8 = function(n) {
                    if (typeof n === "boolean") { i = n }
                    return this };

                function a(n, t) { n = t ? e(n) : n;
                    return u(m(l(n), n.length * 8)) }

                function c(n, t) { n = i ? e(n) : n;
                    t = i ? e(t) : t;
                    var r, o = 0,
                        f = l(n),
                        h = Array(16),
                    ...
                    for (; o < 16; o += 1) { h[o] = f[o] ^ 909522486;
                        a[o] = f[o] ^ 1549556828 }
                ...
                function m(n, e) {
                    ...
                    for (C = 0; C < n.length; C += 16) { f = t[0];
                        ...
                        B = t[7];
                        for (A = 0; A < 64; A += 1) {
                            if (A < 16) { o[A] = n[A + C] } else { o[A] = r(r(r(g(o[A - 2]), o[A - 7]), d(o[A - 15])), o[A - 16]) }
                ...
                function h(n) { n = o ? e(n) : n;
                    return u(c(l(n), n.length * 8)) }

                function a(n, t) { n = o ? e(n) : n;
                    t = o ? e(t) : t;
                    var r, f = 0,
                        i = l(n),
                        h = Array(32),
                    ...
                    for (; f < 32; f += 1) { h[f] = i[f] ^ 909522486;
                        a[f] = i[f] ^ 1549556828 }
                ...
                function c(n, e) {
                    ...
                    for (r = 0; r < o; r += 32) { A(l, u[0]);
                        ...
                        A(v, u[6]);
                        A(m, u[7]);
                        for (t = 0; t < 16; t += 1) { f[t].h = n[r + 2 * t];
                            f[t].l = n[r + 2 * t + 1] }
                        for (t = 16; t < 80; t += 1) { s(j, f[t - 2], 19);
                            w(M, f[t - 2], 29);
                            F(T, f[t - 2], 6);
                            _.l = j.l ^ M.l ^ T.l;
                            _.h = j.h ^ M.h ^ T.h;
                        ...
                        for (t = 0; t < 80; t += 1) { S.l = y.l & b.l ^ ~y.l & v.l;
                            S.h = y.h & b.h ^ ~y.h & v.h;
                            s(j, y, 14);
                            s(M, y, 18);
                            w(T, y, 9);
                        ...
                        E(u[6], u[6], v);
                        E(u[7], u[7], m) }
                    for (r = 0; r < 8; r += 1) { h[2 * r] = u[r].h;
                        h[2 * r + 1] = u[r].l }
                    return h }

                function C(n, e) { this.h = n;
                    this.l = e }

                function A(n, e) { n.h = e.h;
                    n.l = e.l }

                function s(n, e, t) { n.l = e.l >>> t | e.h << 32 - t;
                    n.h = e.h >>> t | e.l << 32 - t }

                function w(n, e, t) { n.l = e.h >>> t | e.l << 32 - t;
                    n.h = e.l >>> t | e.h << 32 - t }

                function F(n, e, t) { n.l = e.l >>> t | e.h << 32 - t;
                    n.h = e.h >>> t }
                ...
                function g(n, e, t, r, o, f) {
                    ...
                    n.l = i & 65535 | h << 16;
                    n.h = u & 65535 | a << 16 } }, RMD160: function(n) {
                var t = n && typeof n.uppercase === "boolean" ? n.uppercase : false,
                    i = n && typeof n.pad === "string" ? n.pda : "=",
                    h = n && typeof n.utf8 === "boolean" ? n.utf8 : true,
                ...
                function s(n, t) { n = h ? e(n) : n;
                    t = h ? e(t) : t;
                    var r, o, f = c(n),
                        i = Array(16),
                        u = Array(16);
                    if (f.length > 16) { f = F(f, n.length * 8) }
                    for (r = 0; r < 16; r += 1) { i[r] = f[r] ^ 909522486;
                        u[r] = f[r] ^ 1549556828 }
                ...
                function F(n, e) {
                    ...
                    n[(e + 64 >>> 9 << 4) + 14] = e;
                    h = n.length;
                    for (i = 0; i < h; i += 16) { w = v = c;
                        F = m = D;
                        p = x = B;
                        y = _ = A;
                        b = S = s;
                        for (f = 0; f <= 79; f += 1) { t = r(w, E(f, F, p, y));
                            t = r(t, n[i + u[f]]);
                            t = r(t, d(f));
                            t = r(o(t, l[f]), b);
                            w = b;
        ...
        (function(e, t) {
            var r = false;
            if (typeof exports === "object") { r = exports;
                if (exports && typeof global === "object" && global && global === global.global) { e = global } }
            if (typeof define === "function" && typeof define.amd === "object" && define.amd) { define(function() {
                    return n }) } else if (r) {
                if (typeof module === "object" && module && module.exports === r) { module.exports = n } else { r.Hashes = n } } else { e.Hashes = n } })(this) })();
